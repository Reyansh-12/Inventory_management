                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <!-- <div id="categorySlider" class="carousel slide slider-container" data-bs-ride="false">
                                    ...
                                    <div class="d-flex">
                                        <div class="card m-2 category-card" style="width: 10rem;">
                                            <img src="/Backend/assets/images/product/product62.png" class="card-img-top" alt="Fruits">
                                            <div class="card-body text-center">
                                                <span class="card-title">Hair care</span>
                                            </div>
                                        </div>
                                        <div class="card m-2 category-card" style="width: 10rem;">
                                            <img src="/Backend/assets/images/product/product63.png" class="card-img-top" alt="Headphones">
                                            <div class="card-body text-center">
                                                <span class="card-title">Face skin</span>
                                            </div>
                                        </div>
                                        <div class="card m-2 category-card" style="width: 10rem;">
                                            <img src="/Backend/assets/images/product/product64.png" class="card-img-top" alt="Accessories">
                                            <div class="card-body text-center">
                                                <span class="card-title">Skin Care</span>
                                            </div>
                                        </div>
                                        <div class="card m-2 category-card" style="width: 10rem;">
                                            <img src="/Backend/assets/images/product/product65.png" class="card-img-top" alt="Accessories">
                                            <div class="card-body text-center">
                                                <span class="card-title">Blusher</span>
                                            </div>
                                        </div>
                                        <div class="card m-2 category-card" style="width: 10rem;">
                                            <img src="/Backend/assets/images/product/product66.png" class="card-img-top" alt="Accessories">
                                            <div class="card-body text-center">
                                                <span class="card-title">Natural</span>
                                            </div>
                                        </div>
                                        <div class="card m-2 category-card" style="width: 10rem;">
                                            <img src="/Backend/assets/images/product/product67.png" class="card-img-top" alt="Accessories">
                                            <div class="card-body text-center">
                                                <span class="card-title">Lip Stick</span>
                                            </div>
                                        </div>
                                    </div>
                                    </div>
